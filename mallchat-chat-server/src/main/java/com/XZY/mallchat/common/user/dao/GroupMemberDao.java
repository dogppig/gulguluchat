...
import com.XZY.mallchat.common.user.domain.enums.GroupMemberEnum;
import com.XZY.mallchat.common.user.mapper.GroupMemberMapper;
...
import static com.XZY.mallchat.common.websocket.domain.enums.GroupRoleEnum.ADMIN_LIST;
...
public class GroupMemberDao extends ServiceImpl<GroupMemberMapper, GroupMember>  {
    ...
    /**
     * 根据用户信息加入群组 默认用户的权限为 普通群员
     * @param user
     * @return
     */
    public Boolean NewUseraddgroup(User user){
        GroupMember groupMember = new GroupMember();
        groupMember.setUid(user.getId());
        groupMember.setRole(GroupRoleEnum.MEMBER.getType());
        groupMember.setGroupId(1L); // 主群
