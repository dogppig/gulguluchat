...
//    private final WxMsgService wxMsgService;
        ...
        @GetMapping("/test")
        public String urltest(@RequestParam Integer code) throws WxErrorException {
            WxMpQrCodeTicket wxMpQrCodeTicket = wxMpService.getQrcodeService().qrCodeCreateTmpTicket(code, 1000);//创建一个临时二维码
