...
import com.XZY.mallchat.common.user.domain.entity.IpDetail;
...
import com.XZY.mallchat.common.websocket.domain.dto.IpResult;
...
//            executor.execute(() -> {
                ...
                if (Objects.nonNull(ipDetail)) {
                    Date date = new Date();
//                    log.info(String.format("第%d次成功,目前耗时：%dms", finalI, (date.getTime() - begin.getTime())));
