...
import com.XZY.mallchat.common.common.Excption.GroupErrorEnum;
...
import com.XZY.mallchat.common.common.event.GroupMemberAddEvent;
...
import com.XZY.mallchat.common.websocket.cache.*;
import com.XZY.mallchat.common.websocket.domain.dto.RoomBaseInfo;
import com.XZY.mallchat.common.websocket.domain.enums.GroupRoleAPPEnum;
...
public class RoomAppServiceImpl implements RoomAppService {
    ...
    @Override
    @RedissionLock(key = "#request.roomId")
    @Transactional(rollbackFor = Exception.class)
