...
import com.XZY.mallchat.common.common.config.ThreadPoolConfig;
...
import com.XZY.mallchat.common.user.domain.entity.IpInfo;
...
import com.XZY.mallchat.common.websocket.NettyUtil;
import com.XZY.mallchat.common.websocket.domain.dto.WSChannelExtraDTO;
...
@Service
@Slf4j
public class WebsocketServiceImpl implements WebsocketServices {
    ...
    //引入微信service
    @Lazy//解决循环依赖
    private WxMpService wxMpServicel;
...
//防御使编程
    ...
    public void authorize(Channel channel, String token) {
        ...
        if(Objects.nonNull(validUid)){
            ...
            sendMSG(channel,websocketAdapter.buildIvalidTokenResp());
        }
    }
...
//所有在线用户发送
    ...
    public void handleLoginReq(Channel channel) throws WxErrorException {
        ...
        //找到微信中申请带参数的二维码
        WxMpQrCodeTicket wxMpQrCodeTicket = wxMpServicel.getQrcodeService().qrCodeCreateTmpTicket(code, (int)DURATION.getSeconds());
        //把码发给前端
