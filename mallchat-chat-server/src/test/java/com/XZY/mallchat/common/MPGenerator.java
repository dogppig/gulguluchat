...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //todo 要改输出路径
        globalConfig.setOutputDir(System.getProperty("user.dir") + "/IM/mallchat-chat-server/src/main/java");
        //设置作者名字
        globalConfig.setAuthor("OYBW");
        ...
        packageConfig.setParent("com.XZY.mallchat.common.user");//自定义包的路径
...
//                "message",
//                "room",
//                "secure_invoke_record"//这里是基础用户模块到联系人列表为止
                //最后三个表
                "user_emoji",
                "sensitive_word",
                "message_mark"
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setPassword("a");
        dataSourceConfig.setUrl("jdbc:mysql://192.168.78.128:3306/mallchat?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}